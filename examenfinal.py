...
def clasificar(trabajadores, sueldos):
...
def reporte(trabajadores, sueldos, sueldo):
...
while True:
    ...
    match op:
        case "1":
            ...
            sueldos = asignarsueldos(trabajadores)

        case "2":
            #Clasificar sueldos
            sueldo = clasificar(trabajadores, sueldos)
        ...
        case "4":
            #Reporte de sueldos
            reporte(trabajadores, sueldos, sueldo)
